      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
              ...
              <div key={property.id} className="flex gap-4 p-4 rounded-xl border border-white/10 bg-white/5 hover:border-white/20 transition-colors group">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <Link to={`/listing/${property.id}`} className="font-medium text-white hover:text-indigo-400 transition-colors">{property.title}</Link>
                      <div className="flex items-center gap-1 text-xs text-neutral-500 mt-1">
                        <MapPin className="w-3 h-3" />{property.location}
                      </div>
                    </div>
        ...
        {properties.length === 0 && (
          <div className="text-center py-20">
            ...
            <Link to="/search" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-black text-sm font-bold uppercase tracking-widest hover:bg-neutral-200 transition-colors">
              Browse Properties
            </Link>
          </div>
        )}
