    ...
    <div ref={mainRef} className="min-h-screen bg-[#050505] text-neutral-300">
      ...
      <nav className="fixed top-0 w-full px-6 h-16 flex justify-between items-center z-50 bg-[#050505]/80 backdrop-blur-xl border-b border-white/5">
        <div className="flex items-center gap-6">
          <Link to="/" className="font-display text-lg font-bold tracking-tight text-white flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 text-xs text-neutral-400">
            <Link to="/settings" className="hover:text-white cursor-pointer transition-colors">
              Dashboard
            </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 relative items-start">
          ...
          <aside className="hidden lg:flex flex-col sticky top-24 h-[calc(100vh-8rem)] shrink-0 w-[60px] hover:w-[240px] bg-[#050505] z-40 group border-r border-white/5 overflow-hidden rounded-r-xl shadow-2xl shadow-black/50" style={{ transitionProperty: 'width', transitionDuration: '500ms', transitionTimingFunction: 'cubic-bezier(0.23,1,0.32,1)' }}>
            <nav className="flex flex-col gap-2 h-full p-3">
              <Link to="/settings" className="flex items-center px-2 py-2.5 text-neutral-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors whitespace-nowrap group/link">
              ...
              <Link to="/search" className="flex items-center px-2 py-2.5 text-neutral-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors whitespace-nowrap group/link">
                <Search className="w-5 h-5 shrink-0 transition-transform group-hover/link:scale-110" />
                <span className="ml-3 text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                  Property Search
                </span>
              </Link>
              <Link to="/deal-team" className="flex items-center px-2 py-2.5 text-white bg-white/5 rounded-lg border border-white/5 relative overflow-hidden whitespace-nowrap group/link">
                <Users className="w-5 h-5 shrink-0 text-white transition-transform group-hover/link:scale-110" />
                <span className="ml-3 text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                  My Team
                </span>
              </Link>
              <Link to="/analytics" className="flex items-center px-2 py-2.5 text-neutral-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors whitespace-nowrap group/link">
                <DollarSign className="w-5 h-5 shrink-0 transition-transform group-hover/link:scale-110" />
                <span className="ml-3 text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                  Finance
                </span>
              </Link>
              <Link to="#" className="flex items-center px-2 py-2.5 text-neutral-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors whitespace-nowrap group/link">
