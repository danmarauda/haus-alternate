      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="space-y-3 mb-8">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm font-medium text-white">
          ...
          <p className="mt-8 text-center text-sm text-neutral-500">
            ...
            <Link to="/register" className="text-white hover:text-indigo-400 transition-colors font-medium">Create one</Link>
          </p>
        </div>
      </div>
      ...
      <div className="hidden lg:block lg:flex-1 relative">
        ...
        <div className="absolute bottom-12 left-12 right-12">
          ...
          <div className="flex items-center gap-3">
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=100&h=100" alt="Sarah" className="w-10 h-10 rounded-full object-cover" />
            <div>
