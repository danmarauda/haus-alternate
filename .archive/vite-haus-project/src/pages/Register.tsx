    ...
    <div className="landing-page min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 overflow-y-auto">
        <div className="max-w-md w-full mx-auto">
          {/* Mobile Logo */}
          <Link to="/landing" className="lg:hidden inline-flex items-center gap-2 mb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <label htmlFor="terms" className="text-xs text-neutral-400">
                I agree to the{" "}
                <Link to="/terms" className="text-white hover:text-indigo-400 transition-colors">Terms of Service</Link>
                {" "}and{" "}
                <Link to="/privacy" className="text-white hover:text-indigo-400 transition-colors">Privacy Policy</Link>
              </label>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-neutral-500">
            ...
            <Link to="/login" className="text-white hover:text-indigo-400 transition-colors font-medium">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
