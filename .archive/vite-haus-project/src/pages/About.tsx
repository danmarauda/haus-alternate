...
import {
  Sparkles, Shield, Zap, Globe, Users, Target, Award, ArrowRight,
  ArrowUpRight, Code, Brain, Lock, Heart, TrendingUp, Building,
} from "lucide-react";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mt-4 mb-3 rounded-2xl border border-white/10 bg-neutral-900/60 px-4 py-3 sm:px-6 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link to="/landing" className="text-sm font-medium text-neutral-300 hover:text-white transition">Home</Link>
              <Link to="/search" className="text-sm font-medium text-neutral-300 hover:text-white transition">Search</Link>
              <Link to="/analytics" className="text-sm font-medium text-neutral-300 hover:text-white transition">Analytics</Link>
          ...
          <div className="grid gap-10 md:grid-cols-2 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:items-center">
                <Link to="/careers" className="group inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white hover:bg-white/10 transition">
                  Join Our Team
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link to="/careers" className="px-6 py-3 rounded-full bg-indigo-600 text-sm font-bold uppercase tracking-widest text-white hover:bg-indigo-500 transition-colors">
              View Careers
            </Link>
            <Link to="/search" className="px-6 py-3 rounded-full border border-white/10 bg-white/5 text-sm font-bold uppercase tracking-widest text-white hover:bg-white/10 transition-colors">
              Explore Platform
            </Link>
          </div>
        </div>
      ...
      <footer className="border-t border-white/10 py-8 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/careers" className="text-xs text-neutral-500 hover:text-white transition-colors">Careers</Link>
          </div>
        </div>
      </footer>
    </div>
