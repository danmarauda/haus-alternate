        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mt-4 mb-3 rounded-2xl border border-white/10 bg-neutral-900/60 px-4 py-3 sm:px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <a
                href="#contact"
                className="hidden md:inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-neutral-200 hover:bg-white/10 transition"
              >
              ...
              <a
                href="#overview"
                className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-gradient-to-r from-white/10 to-white/5 px-4 py-2 text-sm text-white hover:scale-[1.02] transition"
                style={{
                  boxShadow: "0 4px 14px -6px rgba(255,255,255,0.14)",
                }}
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16">
          <div className="grid gap-10 md:grid-cols-2 items-center">
            ...
            <div className="relative">
              <div
                className="w-full max-w-[34rem] rounded-2xl border border-white/10 bg-gradient-to-tr from-white/10 to-white/5 p-6 backdrop-blur-xl"
                style={{
                  boxShadow: "0 10px 40px -16px rgba(255,255,255,0.18)",
                }}
              >
                ...
                >
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-4">
                    {layer.items.map((item, i) => (
                      <div
                        key={i}
                        className="rounded-md border border-white/10 bg-neutral-950/50 p-3 text-center text-sm"
                      >
                        {item}
                      </div>
                    ))}
                  ...
                  <div key={section.title}>
                    ...
                    <div className="space-y-2">
                      {section.items.map((item, i) => (
                        <div
                          key={i}
                          className="rounded-md border border-white/10 bg-neutral-900/60 p-2 text-center text-xs"
                        >
                          {item}
                        </div>
                      ))}
