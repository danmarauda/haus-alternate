    ...
    <div className="min-h-screen bg-[#050505] text-neutral-300">
      ...
      <nav className="fixed top-0 w-full px-6 md:px-12 py-4 md:py-6 flex justify-between items-center z-50 bg-black/80 backdrop-blur-md border-b border-white/10 text-white">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#" className="text-xs font-['Space_Mono'] text-white/60 hover:text-white transition-colors">PROPERTIES</a>
          <a href="#" className="text-xs font-['Space_Mono'] text-white border-b border-white transition-colors">AGENTS</a>
          <a href="#" className="text-xs font-['Space_Mono'] text-white/60 hover:text-white transition-colors">MARKET DATA</a>
        </div>
      ...
      <footer className="bg-black border-t border-white/10 py-24 px-6 md:px-12">
        <div className="max-w-[1600px] mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="text-xs text-neutral-400 hover:text-white transition-colors">Agents</a>
            <a href="#" className="text-xs text-neutral-400 hover:text-white transition-colors">Agencies</a>
            <a href="#" className="text-xs text-neutral-400 hover:text-white transition-colors">Partners</a>
          </div>
          <div className="flex flex-col gap-4">
            <span className="text-[10px] uppercase tracking-widest text-white font-semibold">Product</span>
            <a href="#" className="text-xs text-neutral-400 hover:text-white transition-colors">Intelligence</a>
            <a href="#" className="text-xs text-neutral-400 hover:text-white transition-colors">Valuation</a>
            <a href="#" className="text-xs text-neutral-400 hover:text-white transition-colors">API</a>
          </div>
          <div className="flex flex-col gap-4">
