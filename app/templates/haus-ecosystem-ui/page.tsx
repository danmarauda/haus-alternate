...
export default function HausEcosystemUIPage() {
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-neutral-100 antialiased selection:bg-blue-400/30 selection:text-neutral-100">
      {/* Background Elements */}
      ...
      <header className="relative z-10">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between bg-neutral-900/60 backdrop-blur-lg border border-white/10 rounded-2xl sm:rounded-3xl p-3 mt-6 sm:p-6">
            {/* Brand */}
            <Link
              href="/"
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="inline-flex items-center justify-center h-10 px-6 text-white font-medium text-sm bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 transition-all duration-300 ease-out rounded-full outline-none overflow-hidden">
                Get Started
              </button>
            </div>
          </div>
      ...
      <main className="relative z-10">
            ...
            <div className="max-w-2xl mx-auto mb-12">
              <div className="bg-neutral-900/60 border border-white/10 rounded-2xl p-6 backdrop-blur-lg">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-emerald-500 rounded-full flex items-center justify-center animate-pulse">
                ...
                <div className="text-xs text-neutral-500 text-center">
                  Voice search powered by HAUS AI • &gt;98% accuracy
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {ecosystemModules.map((module) => {
              ...
              const colorClasses = {
                blue: "from-blue-500 to-blue-600 text-blue-400 hover:text-blue-300",
                emerald:
                  "from-emerald-500 to-emerald-600 text-emerald-400 hover:text-emerald-300",
                orange:
                  "from-orange-500 to-orange-600 text-orange-400 hover:text-orange-300",
                purple:
                  "from-purple-500 to-purple-600 text-purple-400 hover:text-purple-300",
                indigo:
                  "from-indigo-500 to-indigo-600 text-indigo-400 hover:text-indigo-300",
                teal:
                  "from-teal-500 to-teal-600 text-teal-400 hover:text-teal-300",
              };
              const bgClasses = {
              ...
              return (
                <div
                  key={module.id}
                  className="group bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 border border-white/10 rounded-2xl p-8 backdrop-blur-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30"
                >
        ...
        >
          ...
          <div className="relative">
            {/* Journey Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-blue-500 via-purple-500 via-orange-500 to-emerald-500 opacity-30 hidden md:block" />

            <div className="space-y-16">
              {journeySteps.map((step) => {
                const Icon = step.icon;
                const colorClasses = {
                  blue: "from-blue-500 to-blue-600 bg-blue-500/20 text-blue-300",
                  purple:
                    "from-purple-500 to-purple-600 bg-purple-500/20 text-purple-300",
                  orange:
                    "from-orange-500 to-orange-600 bg-orange-500/20 text-orange-300",
                  emerald:
                    "from-emerald-500 to-emerald-600 bg-emerald-500/20 text-emerald-300",
                };
                  ...
                  >
                    {step.position === "left" ? (
                      <>
                        ...
                        <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gradient-to-br from-neutral-700 to-neutral-800 rounded-full flex items-center justify-center z-10 border-4 border-zinc-950">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-neutral-950/60 border border-white/10 rounded-2xl p-8">
                ...
                <div className="text-center mb-8">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pb-12">
        <div className="border border-white/10 rounded-3xl p-6 sm:p-12 lg:p-16 backdrop-blur-2xl bg-neutral-900/40">
