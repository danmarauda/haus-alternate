...
export const metadata = {
  ...
  description: "Your personalized property search dashboard with saved properties, market insights, and upcoming viewings.",
}
    ...
    <div className="landing-page min-h-screen">
      ...
      <nav className="fixed top-0 w-full px-6 py-4 flex justify-between items-center z-50 bg-black/80 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="flex items-center gap-2">
          <Link href="/search" className="p-2 rounded-lg hover:bg-white/5 text-neutral-400 hover:text-white transition-colors">
            <Search className="w-5 h-5" />
          </Link>
          <Link href="/notifications" className="p-2 rounded-lg hover:bg-white/5 text-neutral-400 hover:text-white transition-colors relative">
