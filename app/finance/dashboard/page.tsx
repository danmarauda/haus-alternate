...
function FinanceDashboardPageContent() {
  ...
  return (
    <div className="landing-page min-h-screen">
      <div className="min-h-screen antialiased bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 sm:p-8">
        ...
        {/* 3 iPhone Frames */}
        <div className="flex items-center justify-center gap-4 sm:gap-8 lg:gap-10 flex-wrap lg:flex-nowrap" role="group" aria-label="Mobile app showcase">
          ...
          <IPhoneFrame>
            ...
            {/* Content */}
            <div className="h-full overflow-y-auto px-4 sm:px-5 py-6 sm:py-8 scrollbar-hide" role="region" aria-label="Features section">
              {/* Status Bar */}
              <StatusBar />
              ...
              {/* Heading */}
              <h3 className="text-center text-xl sm:text-2xl font-semibold tracking-tight text-white mb-3">
              ...
              <div className="space-y-4">
                ...
                <GlassCard className="bg-gradient-to-br from-sky-500/10 via-transparent to-transparent">
                  <div className="border-gradient-inner rounded-xl p-3 bg-white/5 backdrop-blur-sm border border-white/10">
                    <div className="flex items-center gap-2 text-white/80 text-xs mb-2">
                      <BarChart3 className="h-3.5 w-3.5 text-sky-300" aria-hidden="true" />
                      ...
                      <div className="rounded-lg p-2 bg-white/5 backdrop-blur-sm border border-white/10">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-1.5 h-1.5 w-full rounded-full bg-white/10 overflow-hidden" role="progressbar" aria-valuenow={76} aria-valuemin={0} aria-valuemax={100} aria-label="Sales progress">
                              <div
                ...
                <GlassCard className="bg-gradient-to-br from-emerald-500/10 via-transparent to-transparent">
                  <div className="border-gradient-inner rounded-xl p-3 bg-white/5 backdrop-blur-sm border border-white/10">
                    ...
                    <div className="grid grid-cols-4 gap-2" role="list" aria-label="Available integrations">
          ...
          <IPhoneFrame>
            ...
            {/* Content */}
            <div className="h-full overflow-y-auto px-4 sm:px-5 py-6 sm:py-8 scrollbar-hide" role="region" aria-label="Hero section">
              {/* Status Bar */}
              ...
              <Card className="overflow-hidden aspect-[16/12] rounded-2xl p-3 relative mb-5 bg-white/5 backdrop-blur-sm border border-white/10">
                ...
                {/* Navigation dots */}
                <div className="pointer-events-auto absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5 z-10" role="group" aria-label="Testimonial navigation">
              ...
              {/* Divider */}
              <div className="h-px w-full bg-gradient-to-r from-transparent via-white/10 to-transparent mb-4" aria-hidden="true" />

              {/* Mini metrics */}
              <div className="grid grid-cols-3 gap-2.5" role="list" aria-label="Performance metrics">
          ...
          <IPhoneFrame>
            ...
            {/* Content */}
            <div className="h-full overflow-y-auto px-4 sm:px-5 py-6 sm:py-8 scrollbar-hide" role="region" aria-label="Pricing section">
              {/* Status Bar */}
              <StatusBar />
              ...
              {/* Pricing Cards */}
              <div className="space-y-3 mb-6 sm:mb-8" role="list" aria-label="Pricing plans">
...
function IPhoneFrame({ children }: IPhoneFrameProps) {
  return (
    <Card className="relative w-[320px] sm:w-[360px] lg:w-[393px] h-[700px] sm:h-[800px] lg:h-[852px] bg-black rounded-[50px] sm:rounded-[55px] lg:rounded-[60px] p-2.5 sm:p-3 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] overflow-hidden border-0">
      {/* Notch */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[120px] sm:w-[140px] lg:w-[150px] h-[24px] sm:h-[27px] lg:h-[30px] bg-black rounded-b-2xl sm:rounded-b-[24px] lg:rounded-b-3xl z-10" aria-hidden="true" />
...
function StatusBar({ className = "mb-6 sm:mb-8" }: StatusBarProps) {
  return (
    <div className={`flex items-center justify-between text-white text-xs ${className}`} role="status" aria-label="Phone status">
      <span>9:41</span>
