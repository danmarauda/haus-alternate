      ...
      <nav className="sticky top-0 z-40 backdrop-blur-xl border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/favorites" className="p-2 rounded-lg hover:bg-white/5 text-neutral-400 hover:text-white transition-colors">
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        {selectedProperties.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link href="/favorites" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-black text-sm font-bold uppercase tracking-widest hover:bg-neutral-200 transition-colors">
              Go to Favorites
            </Link>
          </div>
        ) : (
