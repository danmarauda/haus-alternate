    ...
    <div className="min-h-screen bg-[#050505] text-zinc-100">
      ...
      <nav className="fixed top-0 w-full px-6 py-4 md:px-8 h-16 flex justify-between items-center z-50 bg-[#050505]/80 backdrop-blur-xl border-b border-white/5">
        ...
        <div className="hidden md:flex items-center gap-1 bg-white/5 p-1 rounded-lg border border-white/5">
          <Link href="/landing" className="px-4 py-1.5 text-xs font-medium text-neutral-400 hover:text-white transition-colors rounded hover:bg-white/5">Home</Link>
          ...
          <div className="whitespace-nowrap text-xs font-mono py-2 text-neutral-400 animate-infinite-scroll">
            {markets.concat(markets).map((m, i) => (
              <span key={i} className="ticker-item inline-block px-8">
                ...
                {m.price}/sqft
                <span className={`ml-1 ${
                  m.trend === "up" ? "text-green-500" : m.trend === "down" ? "text-red-500" : "text-neutral-500"
                }`}>
...
export const metadata = {
  ...
  description: "Real-time market intelligence and analytics across global prime real estate markets.",
};
