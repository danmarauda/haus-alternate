      ...
      <div className="wrapper">
        ...
        <section className="py-24 px-6 md:px-20 bg-[#050505]">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link href="/search" className="text-xs font-medium uppercase tracking-widest border-b border-white/20 pb-1 hover:border-white hover:text-white text-neutral-400 transition-colors">View All</Link>
          </div>
